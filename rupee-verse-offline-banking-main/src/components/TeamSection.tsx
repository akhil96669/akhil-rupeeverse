...
const TeamSection = () => {
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      bio: "Building the technology that powers our offline-first banking solutions.",
    },
    {
      name: "Harsh Kumar Singh",
      bio: "Overseeing operations and strategizing our expansion across rural India.",
    }
  ];
