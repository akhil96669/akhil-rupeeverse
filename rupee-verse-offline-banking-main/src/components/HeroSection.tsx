              ...
              <div className="card-gradient rounded-3xl p-1 animate-float shadow-lg">
                <div className="bg-card rounded-3xl p-6 overflow-hidden">
                  ...
                  <div className="flex gap-3">
                    <Button className="flex-1 green-gradient hover:animate-gradient-shift">Send Money</Button>
                    <Button variant="outline" className="flex-1 border-white/10 hover:bg-white/5">Request</Button>
                  </div>
                </div>
              </div>
